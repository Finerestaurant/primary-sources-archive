"""FRUS 1945 III 「독일 항복의 열여드레」 → 열람기 규격의 docs.json.
...
# 문서 종류를 칩 다섯 갈래로 묶는다. 자료에 이미 있는 doc_type 값만 쓴다.
# 이 문서철에서는 **정상 간 서한**을 따로 뗐다 — 스탈린이 트루먼에게, 처칠이
# 트루먼에게 직접 쓴 것이 이 열여드레의 마디를 이룬다.
GROUP = {"전보": "A",
         "각서": "B", "각서 초안": "B", "보고서": "B", "보고": "B",
         "회의록": "C", "비망록": "C", "전화 비망록": "C",
         "대화 비망록": "C", "기록": "C",
         "서한": "D", "친서": "D", "성명": "D",
         "지령": "E", "협정": "E", "항복문서": "E"}
