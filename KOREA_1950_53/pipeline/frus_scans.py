...
네 권이 섞여 있으므로 파일 이름에 권을 붙인다 — `50-448.png`. 안 그러면
1950년 권의 448면과 1951년 권의 448면이 서로를 덮어쓴다.
"""
import json
import os
import re
...
VOLS = {"50": "frus1950v07", "51": "frus1951v07p1",
        "52": "frus1952-54v15p1", "53": "frus1952-54v15p2"}

# 해마다 끊어서 내놓으므로 그 해 것만 받는다 — `python3 frus_scans.py 50`.
# 인자가 없으면 전부 받는다.
ONLY = sys.argv[1] if len(sys.argv) > 1 and sys.argv[1].isdigit() else None
